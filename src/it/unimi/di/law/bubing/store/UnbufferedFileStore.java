...
public class UnbufferedFileStore implements Closeable, Store {
	...
	@Override
	public synchronized void store(final URI uri, final HttpResponse response, boolean isDuplicate, final byte[] contentDigest, final String guessedCharset, final String icuGuessedCharset) throws IOException, InterruptedException {
